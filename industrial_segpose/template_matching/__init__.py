...
__all__ = ["AutomaticTemplateSelection", "AssistedMaskResult", "LoadedTemplateEntry", "METHOD_LABELS", "MatchParameters", "MultiTemplateMatcher", "MultiTemplateResult", "RecognizedObject", "TemplateCandidateScore", "TemplateLibrary", "TemplateLibraryEntry", "TemplateMaskQuality", "TemplateMatch", "TemplateMatcher", "TemplateModel", "analyze_template_mask", "build_assisted_mask", "locate_assisted_template", "draw_multi_template_matches", "write_multi_template_result"]
